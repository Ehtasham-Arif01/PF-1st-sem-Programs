...
//using if else.
    if(night_min>=100)
//using formula.
    night_total=0.05*(night_min-100);
    else
    night_total=25;
  }
//using formula.
...
//input no of minutes for premium service.
    printf("\n----PREMIUM SERVICE----\n\n");
    printf("ENTER THE MINUTES USED DURING DAY (6 AM TO 6 PM) :");
    scanf("%f",&day_min);
    printf("ENTER THE MINUTES USED DURING NIGHT (6 PM TO 6 AM) :");
    scanf("%f",&night_min);
  }
